class AdminController < ApplicationController
  ...
  def index
    ...
    if @revenue_by_day.count < 7
      ...
      ordered_days = days_of_week.rotate(current_day_index + 1)

      complete_ordered_array = ordered_days.map { |day| [day, data_hash.fetch(day, 0)] }

      @revenue_by_day = complete_ordered_array
    end
  end
end
